document.addEventListener('DOMContentLoaded', () => {
    ...
    const squares = [
        ...
        { name: "望舒旅館", x: 80, y: 85, event: "「原神を始めたきっかけは？」" }, // 6
        ...
        { name: "浅瀬神社", x: 81.3, y: 13, event: "「好きな魔神・伝説任務は？」" }, // 10
        { name: "スメールシティ", x: 65.5, y: 13, event: "「自慢の聖遺物があれば見せてください！」" }, // 11
        { name: "アアル村", x: 50, y: 13, event: "「神の目が貰えるなら何元素がいい？」" }, // 12
        { name: "ウェネトトンネル", x: 35.4, y: 13, event: "「一番好きなイベントは？」" }, // 13
        ...
        { name: "りゅうせんのしゅう", x: 60, y: 37, event: "「次に引きたいキャラは？」" }, // 18
        { name: "かがりぎのたみ", x: 60, y: 63.9, event: "「好きな爆発のカットインは？」" }, // 19
